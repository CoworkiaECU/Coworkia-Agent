...
<body style="margin: 0; padding: 0; font-family: 'Georgia', serif; background: #F5F5F5;">
  ...
  <div style="max-width: 650px; margin: 0 auto; background: #FFFFFF;">
    ...
    <div style="background-color:#0A0A0A;background:linear-gradient(135deg, #0A0A0A 0%, #1C1C1C 100%); padding: 45px 30px; text-align: center; border-bottom: 2px solid #B0B0B0;">
      <!--[if !mso]><!-->
      <img src="https://coworkia-agent-e97d15dac56f.herokuapp.com/images/logos/propelite.svg"
           alt="PropElite Real Estate"
           width="260" height="78"
           style="display:block;margin:0 auto;max-width:260px;height:auto;border:0;">
      <!--<![endif]-->
      <!--[if mso]><p style="color:#D8D8D8;font-size:30px;margin:0;font-family:Georgia,serif;letter-spacing:3px;">PropElite</p><p style="color:#909090;font-size:11px;margin:8px 0 0 0;letter-spacing:5px;font-family:Arial,sans-serif;">— REAL ESTATE —</p><![endif]-->
    </div>
    ...
    <div style="padding: 0 30px 30px 30px;">
      ...
      <!-- Separador -->
      <div style="height: 1px; background-color:#B0B0B0;background:linear-gradient(to right, transparent, #B0B0B0, transparent); margin: 35px 0;"></div>
  ...
  <div style="max-width: 650px; margin: 0 auto; background: #FFFFFF;">
    ...
    <div style="text-align: center; margin: 35px 0 25px 0;">
      <div style="display: inline-block; width: 80px; height: 80px; border-radius: 50%; background: #C0C0C0; line-height: 80px;">
        <span style="color: #111111; font-size: 38px;">🔔</span>
      </div>
    </div>
