/**
 * TOMI - Agente Especialista en Bienes Raíces
 * Países: Ecuador 🇪🇨 y República Dominicana 🇩🇴
 * Versión: v409 - MVP funcional
 */
...
export const TOMI = {
  ...
  handover: {
    transicion: 'Te conecto con Tomi, nuestro especialista en bienes raíces de Ecuador y República Dominicana.',
    llamado: 'Hola, soy Tomi 🏡. Aurora me compartió que buscas una propiedad. Cuéntame qué necesitas: ¿departamento, casa, oficina? ¿En qué ciudad?'
  },
