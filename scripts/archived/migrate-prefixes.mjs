...
async function run() {
  ...
  const queries = [
    ...
    ["membership_leads PRO-*→ALU (prefijo antiguo boss Aluna)",
      "UPDATE membership_leads SET membership_code = REPLACE(membership_code, 'PRO-', 'ALU-') WHERE membership_code LIKE 'PRO-%'"],
