...
export const AXEL = {
  ...
  getMensajes: (userLanguage = 'es') => ({
    entrada: userLanguage === 'es' ? 'Hola {nombre}. 🚗🔧 Soy Axel de The PaintBull, tomo el relevo desde ahora.\n\nEspecialista en análisis de colisiones con IA. Analizo fotos de tu vehículo y te doy cotización precisa antes de ir al taller.\n\nPara regresar a tu conversación anterior, escribe @aurora.\n\n¿Qué daño tiene tu vehículo? Envíame fotos claras y te ayudo.' :
             ...
             'Hi {nombre}! I\'m Axel from The PaintBull 🔨\n\n📋 **Collision specialist** with 15 years experience:\n• 🚗 Professional bodywork & paint\n• 📸 AI Vision analysis (instant quote)\n• ⏱️ Repair in 3-7 days\n• 💰 From $500 USD depending on damage\n\nWhat damage does your vehicle have? Send me photos for a FREE quote.',
